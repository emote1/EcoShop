...
public class UserListActivity extends AppCompatActivity {
    ...
    private RecyclerView.LayoutManager userLayourManager;
    ...
    private void buildRecyclerView() {
        ...
        userLayourManager = new LinearLayoutManager(this);
        userAdapter = new UserAdapter(userArrayList);

        userRecyclerView.setLayoutManager(userLayourManager);
        userRecyclerView.setAdapter(userAdapter);

        userAdapter.setOnUserClickListener(new UserAdapter.OnUseClickListener() {
            @Override
    ...
    @Override // выход с друзей чата(сигн оут)
