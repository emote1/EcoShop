...
public class ChatActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        List<MessageOp> messageOp = new ArrayList<>();
        adapter = new AwesomeMessageAdapter(this,R.layout.message_item,messageOp);
        ...
        sendMessageButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                MessageOp message = new MessageOp();
        ...
        messagesChildEventListener = new ChildEventListener() {
            @Override
            public void onChildAdded(@NonNull DataSnapshot dataSnapshot, @Nullable String s) {
                MessageOp message = dataSnapshot.getValue(MessageOp.class);
    ...
    @Override //выход с самого начала чата(сигн оут)
